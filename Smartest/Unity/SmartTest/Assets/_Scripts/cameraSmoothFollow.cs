...
// Place the script in the Camera-Control group in the component menu
    ...
    public class cameraSmoothFollow : MonoBehaviour
    {
        ...
        */
        ...
        public bool IsDragObjcet;
        void Awake()
        {
            someListener = new UnityAction(SetDragState);
        }

        void OnEnable()
        {
            EventManager.StartListening("Drag", SetDragState);
        ...
        void OnDisable()
        {
            EventManager.StopListening("Drag", SetDragState);
        }
