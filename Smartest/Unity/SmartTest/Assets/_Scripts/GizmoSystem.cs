...
namespace RTG
{
    ...
    /// </summary>
    public class GizmoSystem : MonoBehaviour
    {
        /// <summary>
        ...
        private Rigidbody[] _transformRigidBody;
        ...
        private void Start()
        {
            ...
            _moveGizmo = _objectMoveGizmo.Gizmo.MoveGizmo;
        ...
        private GameObject PickGameObject()
        {
            ...
            if (Physics.Raycast(ray, out rayHit, float.MaxValue,DragLayer))
        ...
        private void OnTargetObjectChanged(GameObject newTargetObject)
        {
            ...
            if (_targetObject != null)
            {
                ...
                _moveGizmo.SetVertexSnapTargetObjects(new List<GameObject>{_targetObject});
